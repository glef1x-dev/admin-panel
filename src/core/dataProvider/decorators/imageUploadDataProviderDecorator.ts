...
implements DataProvider<ResourceType> {
  ...
  async create(resource: ResourceType, params: CreateParams) {
    ...
    return convertFileToBase64(params.data.image).then((base64Image) => this.dataProvider.create(resource, {
      ...params,
      data: {
        ...params.data,
        image: base64Image,
 ...
 */
const convertFileToBase64 = (file: FileType): Promise<string | ArrayBuffer | null> => new Promise((resolve, reject) => {
